        ...
        lessons: [
          {
            ...
            resource: {
              ...
              description:
                "The upstream React explanation the Next.js implementation follows.",
          ...
          },
          {
            ...
            search:
              "next.js passing props server component to client component",
            summary:
      ...
      },
      {
        ...
        lessons: [
          ...
          },
          {
            ...
            search:
              "kubernetes resource requests limits troubleshooting oomkilled",
            summary:
